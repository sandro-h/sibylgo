...
func TestGenerateInSmallerRange(t *testing.T) {
	...
	insts := Generate(todos.Moments[0], tu.Dt("20.06.2016"), tu.Dt("22.06.2016"))
...
func TestGenerateInLargerRange(t *testing.T) {
	todos, _ := parse.String("[] bla (18.06.2016-25.06.2016)")
	insts := Generate(todos.Moments[0], tu.Dt("01.06.2016"), tu.Dt("01.08.2016"))
...
func TestGenerateOutOfRange(t *testing.T) {
	todos, _ := parse.String("[] bla (18.06.2016-25.06.2016)")
	insts := Generate(todos.Moments[0], tu.Dt("01.07.2016"), tu.Dt("13.07.2016"))
...
[] 2
`)
	insts := GenerateFiltered(todos, tu.Dt("01.06.2016"), tu.Dt("01.08.2016"), nil)
...
[] 1 (18.06.2016-25.06.2016)
	[] 1.1 (20.06.2016-23.06.2016)
`)
	insts := Generate(todos.Moments[0], tu.Dt("01.06.2016"), tu.Dt("21.06.2016"))
	assertInstanceDates(t, insts[0].SubInstances,
...
[] 1 (18.06.2016-25.06.2016)
	...
	[] 1.2 (every day)
`)
	insts := Generate(todos.Moments[0], tu.Dt("01.06.2016"), tu.Dt("20.06.2016"))
	assertInstanceDates(t, insts[0].SubInstances,
		"20.06.2016", "20.06.2016",
...
[] 1 (every 20.)
	...
	[] 1.3 (21.6.2016)
`)
	insts := Generate(todos.Moments[0], tu.Dt("01.06.2016"), tu.Dt("30.07.2016"))
	assertInstanceDates(t, insts[0].SubInstances,
...
func assertInstanceDates(t *testing.T, insts []*Instance, dates ...string) {
